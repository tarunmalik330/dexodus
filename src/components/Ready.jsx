  ...
  return (
    <div className="xl:pt-[140px] md:pt-[90px] sm:pt-[60px] pt-12">
      <div className="container xl:max-w-[1164px] mx-auto xl:px-3 px-6">
        <div className="ready-border-box before:w-full before:h-full before:absolute before:-z-[1] before:p-[2px] before:pointer-events-none lg:before:rounded-full before:rounded-[60px] relative rounded-full">
